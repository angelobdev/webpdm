...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/styles/slideshow.css">
    <script>
    ...
    <div id="masterWrap">
        <div id="panelWrap">
            ...
            <section>
                ...
                />
                <p>
                    This slider demo is powered by GSAP along with the Draggable
                    and Inertia plugins.
                </p>
            </section>
            <section>
                ...
                <p>
                    ...
                    time is based on the position of the draggable element. Keep
                    an eye on it as you drag the slides.
                </p>
            </section>
            <section>
                {" "}
